...
const AboutUs = () => {
  return (
    <div className="bg-[#0D042E] w-full min-h-[30vh] pt-[30px] md:pt-[100px]">
      <div className=" flex flex-col gap-[50px] md:gap-[100px]">
        ...
        <div className=" w-full px-[20px] lg:px-[65px] bg-[#241E4E] min-h-[587px] ">
          <div className="max-w-[1440px] mx-auto w-full flex flex-col lg:flex-row items-center justify-between gap-5 sm:gap-[50px] py-4 md:py-0">
            <img src="/images/home/about.svg" alt="" className="w-[80%] lg:w-[55%] order-2 md:order-1" />
            <div className="flex flex-col gap-[20px] text-[#C5C5C5] w-full lg:w-[45%] text-center md:text-left order-1 md:order-2">
