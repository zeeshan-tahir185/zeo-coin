    ...
    <div className="w-full flex flex-col relative min-h-[800px]" id="tokenomics">
      ...
      <div className="bg-[#190941] w-full md:min-h-[790px] pt-[30px] md:pt-[50px] z-10 relative">
        <div className="flex flex-col lg:flex-row gap-[30px] w-full px-[20px] lg:px-[65px] max-w-[1440px] mx-auto pb-[30px]">
          <div className="flex flex-col gap-[20px] md:gap-[50px] items-start w-full lg:w-[35%] mt-0 lg:mt-[100px] text-start">
          ...
          <img
            ...
            alt=""
            className="mx-auto lg:mx-0 w-[100%] lg:w-[65%] xl:w-[785px]"
          />
        </div>
      </div>
